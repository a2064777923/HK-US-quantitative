...
class HermesReviewPacketTests(unittest.TestCase):
    ...
    def test_packet_marks_valid_dry_run_as_eligible_for_review_approval(self):
        ...
        self.assertIn("reviewed_symbol", payload["judgment_contract"]["append_jsonl_object"])
        self.assertIn("reviewed_signal_type", payload["judgment_contract"]["append_jsonl_object"])
        self.assertIn("reviewed_trigger", payload["judgment_contract"]["append_jsonl_object"])
