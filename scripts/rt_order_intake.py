...
def build_judgment_request(alert, plan, context):
    return {
        ...
        "alert": {
            ...
            "intraday_evidence_policy": alert.get("intraday_evidence_policy"),
            "completed_daily_mutation_allowed": alert.get("completed_daily_mutation_allowed"),
            "partial_daily_bar_used_as_completed_daily": alert.get("partial_daily_bar_used_as_completed_daily"),
